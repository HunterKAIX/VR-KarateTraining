...
public class Gekisai2StartandStop : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //シーン名が"Gekisai2"(鏡なしでの練習)なら"MirrorSwitch"トリガーをTrueにする。
        ...
        //キーボードのSキーを押すと、"Gekisai2Shift"トリガーをTrueにし、型の手本モーションをスタートする。
        ...
        //"State1"が"Wait"ステート以外の時は、"Gekisai2Shift"トリガーをFalseのままにする。
